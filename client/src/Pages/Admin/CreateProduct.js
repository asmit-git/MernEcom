...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.success) {
        toast.success(`${productValues.name} is created`);
            ...
            <div className="grid bg-white  dark:bg-gray-900  rounded-lg shadow-xl w-12/12">
              <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5">
                  ...
                  <button type="submit" className="w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2">Create</button>
                </div>
              </form>
            </div>
          </div>
